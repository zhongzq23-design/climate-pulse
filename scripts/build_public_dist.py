...
PUBLIC_README = """# Climate Pulse\n\nPublic website, generated outputs and open operational runtime for Climate Pulse.\n\nThe operational Python/GEE processing code, quality-control logic and scheduled\ndata-processing workflows are maintained openly in this repository. GitHub Pages\npublishes only the code-free website/generated-output artifact built by\n`scripts/build_public_dist.py`.\n"""
...
def assert_text_only_climate_context(out_root: Path) -> None:
    ...
    The unified repository is the publishing authority. Treat the absence of
